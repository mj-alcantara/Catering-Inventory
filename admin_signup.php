        ...
        try {
            ...
            if ($check_stmt->rowCount() > 0) {
                ...
                $query = "INSERT INTO users (email, password_hash, full_name, phone, user_type) 
                          VALUES (:email, :password_hash, :full_name, :phone, 'admin')";
...
<head>
    ...
    <title>Admin Sign Up - Dimi's Donuts</title>
        ...
        <div class="signup-layout">
            <section class="signup-left">
                <div class="signup-form-card">
                    ...
                    <form class="signup-form" method="POST" action="admin_signup.php" id="signupForm">
                        <div class="signup-field">
                            <label for="signupEmail">Email Address</label>
                            <input type="email" id="signupEmail" name="email" placeholder="admin@example.com" required value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>">
                        </div>
                        <div class="signup-field">
                    ...
                    <div style="text-align: center; margin-top: 20px;">
                        <p style="color: #666;">Already have an admin account? <a href="admin_login.php" style="color: #FF6B8B; text-decoration: none; font-weight: bold;">Login here</a></p>
                    </div>
                </div>
            </section>
