...
<head>
    ...
    <title>Admin Login - Dimi's Donuts</title>
            ...
            <section class="signup-left">
                <div class="signup-form-card">
                    ...
                    <?php if ($error_message): ?>
                        <div class="error-message" style="background: #f8d7da; color: #721c24; padding: 12px; border-radius: 6px; margin-bottom: 20px; border: 1px solid #f5c6cb;">
                            <?php echo htmlspecialchars($error_message); ?>
                        </div>
                    <?php endif; ?>

                    <form class="signup-form" method="POST" action="admin_login.php">
                        <div class="signup-field">
                            <label for="loginEmail">Email Address</label>
                            <input type="email" id="loginEmail" name="email" placeholder="admin@dimidonuts.com" required value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>">
                        </div>
                        <div class="signup-field">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <label for="loginPassword">Password</label>
                                <a href="forgot_pass.php" style="font-size: 0.9rem; color: #FF6B8B; text-decoration: none;">Forgot Password?</a>
                            </div>
                    ...
                    <div class="login-carousel-container">
                        <div class="login-carousel-slides">
                            <div class="login-carousel-slide active">
                                <img src="images/donut-trays/A-series/A1-chocolate.jpg" alt="Chocolate Donuts">
                            </div>
                            <div class="login-carousel-slide">
                                <img src="images/donut-trays/A-series/A2-strawberry.jpg" alt="Strawberry Donuts">
                            </div>
                            <div class="login-carousel-slide">
                                <img src="images/donut-trays/A-series/A3-matcha.jpg" alt="Matcha Donuts">
                            </div>
                        </div>
